        ...
        <ul className="service-list">
          <li className="service-item">
            <div className="service-icon-box">
              <img src={images.iconDesign} alt="design icon" width="40" />
            </div>
          ...
          <li className="service-item">
            <div className="service-icon-box">
              <img src={images.iconDev} alt="Web development icon" width="40" />
            </div>
          ...
          <li className="service-item">
            <div className="service-icon-box">
              <img src={images.iconApp} alt="mobile app icon" width="40" />
            </div>
          ...
          <li className="service-item">
            <div className="service-icon-box">
              <img src={images.iconPhoto} alt="camera icon" width="40" />
            </div>
      ...
      <section className="clients">
        ...
        <ul className="clients-list has-scrollbar">
          <li className="clients-item">
            <a href="#">
              <img src={images.logo1} alt="client logo" />
            </a>
          </li>

          <li className="clients-item">
            <a href="#">
              <img src={images.logo2} alt="client logo" />
            </a>
          </li>

          <li className="clients-item">
            <a href="#">
              <img src={images.logo3} alt="client logo" />
            </a>
          </li>

          <li className="clients-item">
            <a href="#">
              <img src={images.logo4} alt="client logo" />
            </a>
          </li>

          <li className="clients-item">
            <a href="#">
              <img src={images.logo5} alt="client logo" />
            </a>
          </li>

          <li className="clients-item">
            <a href="#">
              <img src={images.logo6} alt="client logo" />
            </a>
          </li>
        </ul>
      </section>
